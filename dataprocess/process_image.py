...
def process_ali(caption_data, image_path, start_ID=0):
    image_map = {}
    captions = {}
...
def main():
    ...
    image_map_ali, captions_ali = process_ali(caption_data_ali, config["ali_image_path"])
    print(f"Processed {len(image_map_ali)} images from ali dataset.")
    
    image_map_chat1, captions_chat1 = process_coco(caption_data_chat1, config["coco_image_path"], len(image_map_ali))
    print(f"Processed {len(image_map_chat1)} images from coco dataset file 1.")
    
    image_map_chat2, captions_chat2 = process_coco(caption_data_chat2, config["coco_image_path"], len(image_map_ali) + len(image_map_chat1))
